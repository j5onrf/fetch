...
ENV_EXAMPLE = os.path.expanduser("~/.config/fetch/.env.example")
CACHE_PATH = os.path.expanduser("~/.config/fetch/.openrouter_cache_v2.json")
CUSTOM_SPACES_FILE = os.path.expanduser("~/.config/fetch/custom_spaces.json")
LAST_KEY_FILE = os.path.expanduser("~/.config/fetch/.last_cloud_key.txt")
