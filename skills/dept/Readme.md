...
The `/home/user/.config/fetch/skills/dept/` directory holds your specialized, role-based "onboarding guides." You can organize them recursively to maintain clean organizational lines:
