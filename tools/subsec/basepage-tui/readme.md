...
```bash
mkdir -p ~/.config/fetch/tools/subsec/basepage-tui/
wget -O ~/.config/fetch/tools/subsec/basepage-tui/basepage.py [https://raw.githubusercontent.com/yourusername/basepage/main/basepage.py](https://raw.githubusercontent.com/yourusername/basepage/main/basepage.py)
chmod +x ~/.config/fetch/tools/subsec/basepage-tui/basepage.py
...
```bash
python3 ~/.config/fetch/tools/subsec/basepage-tui/basepage.py
